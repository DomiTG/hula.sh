    ...
    <div className="min-h-screen h-full flex justify-center bg-neutral-900 p-4">
      <div className="max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl w-full">
        <div className="sticky top-2">
          <nav className="flex justify-between items-center p-4 rounded-md bg-neutral-800 backdrop-blur-lg bg-opacity-50 border border-neutral-800 z-[40]">
        ...
        <section className="p-4">
          <div className="w-full relative p-8 bg-neutral-800 rounded-md border border-neutral-800 backdrop-blur-md bg-opacity-50 hover:bg-opacity-60 transition-all cursor-pointer">
            ...
            <p className="text-neutral-500 mt-1 max-w-[50%] relative z-10">
        ...
        <footer className="p-4 text-neutral-500 text-xs text-center">
          © {new Date().getFullYear()} Dominik Hůla. All rights reserved.
        </footer>
      </div>
    </div>
  );
